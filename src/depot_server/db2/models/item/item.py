...
class Item(Model):
    ...
    report_profile = fields.ForeignKeyField(ReportProfile, on_delete=fields.RESTRICT, null=True)
    group = fields.ForeignKeyField(ItemGroup, on_delete=fields.RESTRICT, null=False)
    storage_location = fields.ForeignKeyField(StorageLocation, on_delete=fields.RESTRICT, null=True)
    assets = fields.ManyToManyField(Asset, on_delete=fields.RESTRICT)
    tags = fields.ManyToManyField(Tag, null=True, on_delete=fields.SET_NULL)
